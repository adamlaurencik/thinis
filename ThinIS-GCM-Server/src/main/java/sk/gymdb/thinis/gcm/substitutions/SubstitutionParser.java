...
public class SubstitutionParser {
    ...
    public void GetData() {
        ...
        try {
            ...
            String cookies="utmv=182002547.edupage9; path=/; __utmz=182002547.1387631395.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); path=/; PHPSESSID=rtrcmkn2p9lbpcjgui0hmmusd2; path=/; "
                    + "__utmb=182002547.2.10.1387644012; path=/; __utmc=182002547; path=/";
